...
@Component("changePasswordAndLoginRequestValidator")
public class ChangePasswordAndLoginRequestValidator implements Validator {
    public boolean supports(Class<?> clazz) {
	return ChangePasswordAndLoginRequest.class.isAssignableFrom(clazz);
    }

    public void validate(Object target, Errors errors) {
	ChangePasswordAndLoginRequest req = (ChangePasswordAndLoginRequest) target;
